...
const VideoBackground = () => {
  ...
  const video = useMemo(() => {
    ...
    // Using a more reliable, standard space travel stock video preview
    ...
    // Handle the play promise to avoid unhandled rejections on autoplay block
    v.play().catch(err => {
  ...
  return (
    <Mesh ref={meshRef} position={[0, 0, -5]} scale={[18, 10, 1]}>
      <PlaneGeometry />
      <MeshBasicMaterial map={texture} toneMapped={false} transparent opacity={0.8} />
    </Mesh>
  );
};
